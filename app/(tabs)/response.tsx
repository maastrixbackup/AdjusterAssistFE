...
export default function ResponseScreen() {
  ...
  async function onSave() {
    ...
    if (!fId || fId === "undefined") {
      toast.warning("Workspace missing");
      return;
    }
    try {
      setSaving(true);
      const sanitizedToken = token?.startsWith("Bearer ")
        ...
        : token;
      let result =
        params.alreadySaved === "true" && params.draftId
          ? await updateDraft(sanitizedToken!, params.draftId, {
              content: editedText,
              output_format: params.output_format || "",
            })
          : await saveDraft(
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <View style={styles.headerContent}>
          ...
          <View style={{ flexDirection: "row", gap: 8 }}>
            ...
            <Pressable
              onPress={() => Share.share({ message: editedText })}
              style={styles.iconButton}
            >
            ...
            <View style={styles.nextStepContent}>
              ...
              <View>
                ...
                <Text style={styles.nextStepSub}>
                  Draft the mandatory follow-up documentation
                </Text>
              </View>
            </View>
            {isGeneratingNext ? (
      ...
      {/* FIXED FOOTER */}
      <View
        style={[styles.floatingFooter, { paddingBottom: insets.bottom + 20 }]}
      >
              ...
              {saving ? (
                ...
                <>
                  ...
                  <Text style={styles.buttonText}>
                    {isEditing ? "Confirm" : isSaved ? "Saved" : "Save Draft"}
                  </Text>
                </>
              )}
            </LinearGradient>
